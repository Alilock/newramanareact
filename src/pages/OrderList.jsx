              ...
              <div className="order__container__box__upper">
                <ul className="order__container__box__upper__ul">
                  <li className="order__container__box__upper__ul__li">
                    <h3>DATE OF ORDER</h3>{" "}
                    <span>{moment(o.createdDate).format("DD MMM YYYY")}</span>
                  </li>
                  <li className="order__container__box__upper__ul__li">
                    <h3>NUMBER OF ITEMS</h3>{" "}
                    <span>{o.orderItems.length} ITEMS</span>
                  </li>
                  <li className="order__container__box__upper__ul__li">
                    <h3>NAME OF BUYER</h3>{" "}
                    <span>
                  ...
                  <li className="order__container__box__upper__ul__li">
                    <h3>DELIVERY DATE</h3>{" "}
                    <span>
                      {moment(o.createdDate).add(2, "d").format("DD MMM YYYY")}
                    </span>
                  </li>
                </ul>
              </div>
              <div className="order__container__box__down">
                ...
                <div className="order__container__box__down__right col-10">
                  {o.orderItems.map((order) => (
                    <div
                      key={order.product.images[0].path}
                      className="order__container__box__down__right__image"
                    >
                      <img
